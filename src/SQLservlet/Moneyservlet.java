...
public class Moneyservlet extends HttpServlet {
	...
	public void findpaginglist(HttpServletRequest request,
		...
		if(ifvalue.equals("week")){
			ifvalues = "and pay_date between to_date('2017-06-03 00:00:00','YYYY-MM-DD HH24:MI:SS') and to_date('2017-06-09 23:59:59','YYYY-MM-DD HH24:MI:SS')";
			request.setAttribute("starttime", "2017-06-03 00:00:00");
			request.setAttribute("endtime", "2017-06-09 23:59:59");
